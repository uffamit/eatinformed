...
let extractIngredientsPrompt: any = null;
let extractIngredientsFlow: any = null;

if (ai) {
  extractIngredientsPrompt = ai.definePrompt({
  ...
  extractIngredientsFlow = ai.defineFlow(
    {
